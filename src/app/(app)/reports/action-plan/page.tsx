...
import { Plus, Search, Eye, AlertCircle, ClipboardList, Calendar, Download, Edit, Trash2 } from 'lucide-react'
                          ...
                          {report.report_status === 'draft' && (
                            <>
                              <Button
                                variant="ghost"
                                size="sm"
                                onClick={() => router.push(`/reports/action-plan/${report.id}/edit`)}
                              >
