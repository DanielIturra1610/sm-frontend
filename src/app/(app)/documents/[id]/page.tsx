      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Document #{document.id.slice(0, 8)}</p>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {document.content.sections.length} sections
              </CardDescription>
            </CardHeader>
          ...
          {document.content.variables && Object.keys(document.content.variables).length > 0 && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>Data used to generate this document</CardDescription>
              </CardHeader>
              <CardContent>
